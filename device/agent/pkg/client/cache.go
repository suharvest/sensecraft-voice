...
type SensecraftVoiceInformer struct {
	Shared informers.SharedInformerFactory
	Cancel context.CancelFunc
}

func (p SensecraftVoiceInformer) NodesLister() v1.NodeLister {
	return p.Shared.Core().V1().Nodes().Lister()
}

func (p SensecraftVoiceInformer) PodsLister() v1.PodLister {
	return p.Shared.Core().V1().Pods().Lister()
}

func (p SensecraftVoiceInformer) NamespacesLister() v1.NamespaceLister {
	return p.Shared.Core().V1().Namespaces().Lister()
}

func (p SensecraftVoiceInformer) DeploymentsLister() appsv1.DeploymentLister {
	return p.Shared.Apps().V1().Deployments().Lister()
}

func (p *SensecraftVoiceInformer) StatefulSetsLister() appsv1.StatefulSetLister {
	return p.Shared.Apps().V1().StatefulSets().Lister()
}

func (p *SensecraftVoiceInformer) DaemonSetsLister() appsv1.DaemonSetLister {
	return p.Shared.Apps().V1().DaemonSets().Lister()
}

func (p *SensecraftVoiceInformer) CronJobsLister() batchv1.CronJobLister {
	return p.Shared.Batch().V1().CronJobs().Lister()
}

func (p *SensecraftVoiceInformer) JobsLister() batchv1.JobLister {
	return p.Shared.Batch().V1().Jobs().Lister()
}
...
type ClusterSet struct {
	...
	Informer *SensecraftVoiceInformer
}
...
func (cs *ClusterSet) Complete(cfg []byte) error {
	...
	cs.Informer = &SensecraftVoiceInformer{
